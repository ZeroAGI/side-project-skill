...
- **发现有效信号**：145 + 15 条（12 组常规扫描 145 条 + WAIC 2026 补扫 15 条。常规扫描窗口以 2026 年 6 月至 7 月初为主，部分渠道信号有滞后，引用日期照实标注。注：WAIC 2026（7/17-7/20 上海）周末刷屏，但原扫描因工作流日期参数失效回退到 6 月时间窗而漏测，本期以事后补扫收录，workflow 缺陷已修复）
...
### 行业大会特别信号：WAIC 2026（补扫）

> WAIC 2026 于 7 月 17-20 日在上海举办，与本报告发布同期。原扫描因日期参数缺陷漏测，以下为事后补扫信号（15 条）。

**大会概况**

- **规模创纪录：展览首破 10 万平米** — 「三地四馆」举办，1,100+ 家企业参展、3,000+ 展品、300+ 款全球首发；细分展品含 108 款芯片、261 个基础模型、208 个具身智能终端；140+ 场论坛、9 位图灵奖/诺奖得主（Richard Sutton 主旨演讲）[新浪财经](https://finance.sina.com.cn/jjxw/2026-07-17/doc-iniiaxpf8176685.shtml) · 2026-07-17
- **最高规格背书 + 全球治理落子** — 习近平出席开幕式（宣布 5 年向发展中国家提供 5,000 个 AI 研修名额）；大会前夕 29 国签署协定成立**世界人工智能合作组织**（总部上海）[Wikipedia](https://en.wikipedia.org/wiki/World_Artificial_Intelligence_Conference) · 2026-07-16/17
- **一票难求** — 官宣后 10 分钟门票售罄，168 元单日票黄牛价炒至 1,300 元；上海 394 家规上 AI 企业 2025 年产值 6,370 亿元（+39.5%）[虎嗅](https://www.huxiu.com/article/4876467.html) · 2026-07-17
- **参展结构大洗牌：「造模型」→「用模型」** — 大模型与生成式 AI 参展 130 家中 **83 家（63.8%）以 Agent/智能应用为主标签，AI 基础大模型仅剩 18 家**；机器人与智能硬件 242 家成最大赛道（23.6%）[甲子光年](https://www.163.com/dy/article/L23E0KM40512MLBG.html) · 2026-07-18

**头条发布**

- **月之暗面 Kimi K3：2.8 万亿参数全球最大开源模型** — WAIC 前夕发布，100 万 token 上下文——开源规模路线押注 [甲子光年](https://www.163.com/dy/article/L23E0KM40512MLBG.html) · 2026-07
- **阶跃星辰 Step AOS：全球首个智能体原生 OS + AI 手机 STEPX Neo** — 端侧指令执行 100 毫秒、通过首批智能终端国标 L3 级测试获「镇馆之宝」；个人智能体 Amoo 联动携程/支付宝/飞书，金融操作需用户确认、误删可撤回 [虎嗅](https://www.huxiu.com/article/4876467.html) · 2026-07-13
- **阿里云 Agent Native Cloud + 灵骏真武 M890 超节点** — 「智能体原生的云」+ AgentTeams/Agentic Computer；真武芯片累计出货 56 万片；支付宝已完成 **3 亿笔 AI 智能体支付**并推出 AI 订阅服务 [财联社](https://www.cls.cn/detail/2430310) · 2026-07-18
- **华为 Atlas 950 SuperPoD 真机首秀** — 业界最大超节点，最大支持 8,192 张昇腾 950DT 直连（去年 384 卡→今年 8,192 卡）；现场展商反映「很难抢、靠配额」；至少 8 家展商展出超节点形态 [网易](https://www.163.com/dy/article/L284RB1A05198R91.html) · 2026-07-17
- **中科曙光「曙光8000（登峰）」** — 中国首个全国产十万卡 AI 超集群全球首秀 [新浪财经](https://finance.sina.com.cn/jjxw/2026-07-17/doc-iniiaxpf8176685.shtml) · 2026-07-17
- **MiniMax M3 多模态旗舰 + Code 2.0 桌面端** — Code 2.0 基于开源框架 Pi Agent 全面重构，主打会话启动速度、长任务稳定性、工具调用上下文衔接 [新浪财经](https://finance.sina.com.cn/jjxw/2026-07-17/doc-iniiaxpf8176685.shtml) · 2026-07-17
- **智元远征 A3 Ultra（镇馆之宝）+ 具身量产元年** — 全球首个可量产商业化部署的全尺寸人形机器人；参展机器人企业 80+→200+ 家、300+ 台真机动态运行；工信部预计 2026 年人形机器人产量破 10 万台 [虎嗅](https://www.huxiu.com/article/4876467.html) · 2026-07-17/18
- **端侧 AI 备案与国标浮出水面** — 网信办发布**首批 7 款手机端侧 AI 大模型备案名单**（含「努比亚豆包手机大模型」）；智能终端国标 L3 级测试首批放行——中国 AI 合规体系向「端侧/Agent」延伸的明确信号 [虎嗅](https://www.huxiu.com/article/4876467.html) · 2026-07-16

**厂商战略**

- **「Token 工厂」成新商业范式** — 约 20+ 家展台打此概念；中国日均 Token 调用量从 2024 初 1,000 亿飙至 2025 底 100 万亿；计费从 CPU/存储转向 **Token 量与任务结果**，竞争指标变为「每千瓦时有效 Token」；报道同时警示不少 Token 工厂实为模型转卖赚差价 [36kr](https://eu.36kr.com/en/p/3900957398960006) · 2026-07-18
- **字节：借壳终端下沉，MCP 成准入协议** — 豆包×努比亚二代 AI 手机备货从 3 万台提至数十万台；合作模式要求应用方**自行提供 MCP 服务并开放数据**才能被豆包手机接入 [虎嗅](https://www.huxiu.com/article/4876467.html) · 2026-07-16
- **腾讯/百度：从 DAU 到 DAA** — 腾讯 WorkBuddy 称国内 DAU 最高办公智能体；百度首提 **DAA（日活智能体数）**概念——Agent 时代的新北极星指标 [甲子光年](https://www.163.com/dy/article/L23E0KM40512MLBG.html) · 2026-07-18
- **阿里：Agentic 时代全栈五层通吃** — 真武芯片→超节点→Agent Native Cloud→千问模型→终端合作（荣耀/Bose 耳机）；荣耀 Robot Phone 携 Agentic OS 同场呼应 [财联社](https://www.cls.cn/detail/2430310) · 2026-07-18
- **模型创业公司路径分化，收敛完成** — Kimi 押开源规模、阶跃押终端 OS、百川 All in 医疗（HealthBench 全球第一）、MiniMax 押多模态+Code；基础模型玩家仅剩 18 家——通用 Agent 平台/OS、基础大模型、AI 手机硬件三条赛道对独立开发者关闭，垂类 know-how + Agent 编排仍开放 [甲子光年](https://www.163.com/dy/article/L23E0KM40512MLBG.html) · 2026-07-18
...
11. **「Token 工厂」叙事与本期榜首 Cost Guardian 互证**：WAIC 20+ 家展台卖 Token、中国日均调用两年 1,000 亿→100 万亿、计费转向 Token 量/任务结果、竞争指标变为「每千瓦时有效 Token」——与 Copilot 计费风暴、AiKey $100M、BAAI Token Economics 论坛构成同一条主线：**大厂在卖 Token，没人替买方算账**，Token 消耗审计/比价/任务级归因是买方侧空白。
12. **端侧模型备案 + 终端 L3 国标与中国合规机会互证**：网信办首批 7 款手机端侧大模型备案、智能终端国标 L3 测试放行——中国合规体系从「生成式内容」（小红书限流/标注新规）延伸到「端侧 Agent 与智能终端」，合规工具市场扩容而非收窄。
13. **「模型懂世界、不懂组织」与记忆层机会互证**：36kr WAIC 报道点名企业上下文（权限/审批/追责规则）是 Agent 交付关键、「过期上下文比没有更糟」，特赞 GEA 四层架构（含上下文层）已服务 180+ 企业——组织记忆/上下文工程被中国企业侧独立确认为创业层机会，与 Ask HN/Reddit/arXiv 的个人开发者侧信号合流。
...
9. **（WAIC 补扫）中国行业叙事从「造模型」转向「用模型」**：WAIC 参展的大模型公司中 Agent/智能应用占 83 家（63.8%）而基础大模型仅剩 18 家——收敛完成；通用 Agent 平台/OS、基础模型、AI 手机三条赛道被大厂重兵占领，对独立开发者开放的是垂类 Agent（酶设计 2-5 年→2-6 个月、百川医疗）、具身数据/评测工具链和 Agent 配套中间件。
10. **（WAIC 补扫）MCP 成终端 Agent 生态的准入协议**：豆包手机要求应用自建 MCP Server 并开放数据才能接入——协议层身位即分发权；「帮长尾应用快速生成/托管 MCP Server」有了明确付费方（想上豆包/阶跃/荣耀终端的中小应用）。
...
**WAIC 2026 补扫对已追踪机会的强化**：

- **Cost Guardian（本期榜首）**：「Token 工厂」20+ 展台 + 「每千瓦时有效 Token」官方级指标 + Token 量/任务结果计费——中国供给侧把 token 经济学抬为一级竞争维度，买方侧审计/归因空白与本期榜首判断互证。
- **多模型韧性路由**：8+ 家超节点（华为/阿里/燧原/沐曦/摩尔线程等）多技术栈并存 + 昇腾靠配额分配，36kr 明确结论「降低迁移/调度摩擦者赢得开发者」——路由层需求从「海外模型下架风险」扩展到「国产算力多栈适配」。
- **Agent Runtime Security / 审批分级**：阶跃 Amoo 金融操作需确认、误删可撤回、Step AOS 内置沙箱与可观测性；虎嗅点名「支付确认边界、跨应用权限、误操作撤回」为全行业待解——头部厂商公开背书了确认/撤回/沙箱作为产品刚需。
- **中国 AI 合规（扩容）**：首批 7 款端侧模型备案 + 终端 L3 国标——合规工具市场从内容层扩展到端侧 Agent/智能终端层。
- **代码验证层（无增量，维持原判）**：本届无直接对标发布；MiniMax Code 2.0 的「长任务稳定性」与西门子 Eigen 的「规划-执行-验证」显示验证环节正被内置进 Agent 产品，独立品类判断不变。
- **机会关闭警示**：通用 Agent 平台/OS（阿里 AgentTeams/阶跃 AOS/荣耀 Agentic OS）、基础大模型（仅 18 家存活）、AI 手机终端（大厂补贴战）三条赛道对独立开发者关闭。
